# Arithmatic optimization.
# This code contains 
# 1) cacluation the operator for the optimum simulation against big-tree data 
#    using 3 different methods
# 2) apply the same operator to all-tree data
...
#### Temporate script to record simple optimization
### version 1 written 10.08.2020
